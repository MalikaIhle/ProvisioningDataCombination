...
For these cases, the dependent variable 'PairDivorce' is NA (i.e. those broods were excluded).
...
## Fitness correlates: exploratory analyses requested by reviewer

### Chick Survival from age 6 to age 10 explained by coordination at age 6

```{r}
summary(modChickSurvival610)
drop1(modChickSurvival610, test="Chisq") # Likelihood ratio test
dispersion_glmer(modChickSurvival610) # from package blmeco
```


### Divorce as a function of coordination at different chick age
