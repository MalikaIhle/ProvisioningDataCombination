...
if(ASP == 'A')
{mod <- glm(A~ Type*TotalP + Type*DiffP, data=fulldat_long, family = 'poisson')
return(summary(mod)$coeff[4:5,4])}

if(ASP == 'S')
{mod <- glm(S~ Type*TotalP + Type*DiffP, data=fulldat_long, family = 'poisson')
return(summary(mod)$coeff[4:5,4])}
