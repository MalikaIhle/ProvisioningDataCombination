...
{## to test the link between A (or Adev) and TP
...
results$modA[results$Factor=='TotalP'] <- round(summary(modA)$coef[5,4],3)
results$modA[results$Factor=='DiffP'] <- round(summary(modA)$coef[6,4],3)
